...
class StoreFileCommentResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        $html = view('pages/task/components/filecomment', compact('comments'))->render();
        $jsondata['dom_html'][] = array(
            'selector' => '#card-comments-container-'.$payload['id'],
            'action' => 'prepend',
            'value' => $html);
