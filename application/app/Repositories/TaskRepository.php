...
class TaskRepository {
    ...
    public function autocompleteClientsTasksFeed($status = '', $limit = '', $client_id = '', $searchterm = '') {

        //start
        $query = $this->tasks->newQuery();
        $query->selectRaw("CONCAT(COALESCE(task_job_number, ''),' ',task_title) AS value, task_id AS id");
