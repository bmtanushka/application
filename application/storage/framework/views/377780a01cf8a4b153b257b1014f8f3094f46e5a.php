...
<aside class="left-sidebar" id="js-trigger-nav-team">
    ...
    <div class="scroll-sidebar" id="main-scroll-sidebar">
        ...
        <nav class="sidebar-nav" id="main-sidenav">
            <ul id="sidebarnav" data-modular-id="main_menu_team">
                ...
                <li data-modular-id="main_menu_team_everything"
                    class="sidenav-menu-item <?php echo e($page['mainmenu_everything'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                    title="<?php echo e(cleanLang(__('lang.everything'))); ?>">
                    <a class="waves-effect waves-dark" href="/everything" aria-expanded="false" target="_self">
                        <i class="sl-icon-clock"></i>
                        <span class="hide-menu"><?php echo e(cleanLang(__('lang.everything'))); ?>
                ...
                <li data-modular-id="main_menu_team_knowledgebase"
                    ...
                    <a class="waves-effect waves-dark p-r-20" href="/knowledgebase" aria-expanded="false"
                        ...
                        <span class="hide-menu">FAQ & Guides
                        </span>
                    </a>
                </li>
                <?php endif; ?>
                ...
                <!--everything[done]
                <?php if(config('visibility.modules.tasks')): ?>
                <li data-modular-id="main_menu_team_filemanager"
                    class="sidenav-menu-item <?php echo e($page['mainmenu_filemanager'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                    title="File Manager">
                    <a class="waves-effect waves-dark" href="https://files.task-meister.com/" aria-expanded="false" target="_new">
                        <i class="sl-icon-docs"></i>
                        <span class="hide-menu">File Manager
                        </span>
                    </a>
                </li>
                <?php endif; ?>
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH /home/wec24/public_html/application/resources/views/nav/leftmenu-team.blade.php ENDPATH**/ ?>