<head>
    ...
    <link href="public/css/custom.css?v=20241209_<?php echo e(config('system.versioning')); ?>" rel="stylesheet">
    ...
    <link rel="apple-touch-icon" sizes="144x144" href="public/images/favicon/apple-icon-144x144.png">c
    ...
    <script type="text/javascript">
        ...
        NX.array_3 = [];
        NX.array_4 = [];
        window.js_sp_clients = [9,4];
        window.js_sp_client_users = [22,13,37,38];
    </script>
...
</head><?php /**PATH /home/wec24/public_html/application/resources/views/layout/header.blade.php ENDPATH**/ ?>