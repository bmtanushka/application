        ...
        <ul data-modular-id="project_tabs_menu" class="nav nav-tabs profile-tab project-top-nav list-pages-crumbs"
            ...
            <li class="nav-item">
                <a class="nav-link tabs-menu-item   js-dynamic-url js-ajax-ux-request" data-toggle="tab"
                    ...
                    href="#projects_ajaxtab" role="tab"><?php echo e(cleanLang(__('lang.tasks'))); ?> (<?php echo e($project->count_all_tasks); ?>)</a>
            </li>
            <?php endif; ?>
            <!--[milestones]-->
            ...
            <li class="nav-item">
                <a class="nav-link  tabs-menu-item   js-dynamic-url js-ajax-ux-request <?php echo e($page['tabmenu_files'] ?? ''); ?>"
                    ...
                    href="#projects_ajaxtab" role="tab"><?php echo e(cleanLang(__('lang.files'))); ?> (<?php echo e($project->count_files); ?>)</a>
            </li>
            <?php endif; ?>
            <!--[comments]-->
            ...
            <li class="nav-item ">
                <a class="nav-link  tabs-menu-item   js-dynamic-url js-ajax-ux-request <?php echo e($page['tabmenu_discussions'] ?? ''); ?>"
                    ...
                    href="#projects_ajaxtab" role="tab"><?php echo e(cleanLang(__('lang.comments'))); ?> (<?php echo e($project->count_all_comments); ?>)</a>
            </li>
            <?php endif; ?>
            <!--billing-->
...
</div><?php /**PATH /home/wec24/public_html/application/resources/views/pages/project/components/misc/topnav.blade.php ENDPATH**/ ?>