...
<tr id="project_<?php echo e($project->project_id); ?>">
    ...
    <td class="projects_col_project <?php echo e(config('table.tableconfig_column_2')); ?> tableconfig_column_2">
        <a href="<?php echo e(_url('/projects/'.$project->project_id)); ?>" title="<?php echo e($project->project_title); ?>" data-toggle="tooltip"><?php echo e(str_limit($project->project_title ??'---', 20)); ?><a />
            <!--automation-->
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row--><?php /**PATH /home/wec24/public_html/application/resources/views/pages/projects/views/list/table/ajax.blade.php ENDPATH**/ ?>