...
<div class="card" id="project_details" data-progress="<?php echo e($project->project_progress); ?>">
    ...
    <!--billing details-->
    <?php if(config('visibility.project_billing_summary') && !auth()->user()->is_client): ?>
    <div class="card-body p-t-0 p-b-0">
        <div class="row">
            <div class="col-sm-6">
                <div>
...
<!-- Column --><?php /**PATH /home/wec24/public_html/application/resources/views/pages/project/components/misc/details.blade.php ENDPATH**/ ?>