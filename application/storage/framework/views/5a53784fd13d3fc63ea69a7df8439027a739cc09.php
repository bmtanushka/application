<div class="card" id="comments-wrapper">
    ...
    <div class="comments card-body" id="js-trigger-comments" data-payload="<?php echo e($unique_comment_id); ?>">
        <div id="replying_pjt_cmt_wrapper">
            <span type="button" class="btn-close" onclick="replyPjtCmtClose()" aria-label="Close">✖</span>
            <div id="replying_pjt_cmt_text_viewer" class=""></div>
        </div>
...
</div><?php /**PATH /home/wec24/public_html/application/resources/views/pages/comments/wrapper.blade.php ENDPATH**/ ?>