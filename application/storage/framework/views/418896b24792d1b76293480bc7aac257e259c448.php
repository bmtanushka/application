...
<div class="post-comment" id="post-card-comment-form">
    <div id="replying_tsk_cmt_wrapper">
            <span type="button" class="btn-close" onclick="replyTskCmtClose()" aria-label="Close">✖</span>
            <div id="replying_tsk_cmt_text_viewer" class=""></div>
        </div>
    <!--placeholder textbox-->
...
<!--/#complete commenting form-->
<?php endif; ?><?php /**PATH /home/wec24/public_html/application/resources/views/pages/task/components/post-comment.blade.php ENDPATH**/ ?>