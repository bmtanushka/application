...
<div class="col-md-12 <?php echo e(runtimeCrumbsColumnSize($page['crumbs_col_size'] ?? '')); ?> align-self-center <?php echo e($page['crumbs_special_class'] ?? ''); ?>" id="breadcrumbs">
    <?php if(in_array(auth()->user()['id'], SP_CLIENT_USERS) && $page['heading']=='Tasks'): ?>
    ...
    <ol class="breadcrumb">
        ...
        <?php if(in_array(auth()->user()['id'], SP_CLIENT_USERS) && $title=='Tasks'): ?>
            <li class="breadcrumb-item <?php if($loop->last): ?> active active-bread-crumb <?php endif; ?>">Jobs</li>
        <?php else: ?>
...
<?php endif; ?>
<?php /**PATH /home/wec24/public_html/application/resources/views/misc/heading-crumbs.blade.php ENDPATH**/ ?>