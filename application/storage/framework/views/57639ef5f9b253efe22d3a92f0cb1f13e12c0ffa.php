...
<aside class="left-sidebar" id="js-trigger-nav-team"> <!--[fix] keep id as "js-trigger-nav-team"-->
                ...
                <li data-modular-id="main_menu_client_projects"
                    ...
                    title="<?php echo e(cleanLang(__('lang.projects'))); ?>">
                        <?php if(in_array(auth()->user()['id'], SP_CLIENT_USERS)): ?>
                            <a class="waves-effect waves-dark" href="<?php echo e(_url('/tasks')); ?>" aria-expanded="false"
                        target="_self">
                                <i class="ti-folder"></i>
                        ...
                        target="_self">
                                <i class="ti-folder"></i>
                            <span class="hide-menu"><?php echo e(cleanLang(__('lang.projects'))); ?></span>
                        <?php endif; ?>
                    </a>
                </li>
                <?php endif; ?>
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH /home/wec24/public_html/application/resources/views/nav/leftmenu-client.blade.php ENDPATH**/ ?>