                        ...
                        data-loading-class="loading-before-centre" data-loading-target="card-tasks-left-panel"><span
                                class="hidden-sm-up"><i class="ti-home"></i></span> 
                                    <?php if(in_array(auth()->user()['id'], SP_CLIENT_USERS)): ?>
                                        <span class="hidden-xs-down">Job</span>
                                    <?php else: ?>
                                        <span class="hidden-xs-down"><?php echo app('translator')->get('lang.task'); ?></span>
                                    <?php endif; ?>
                                </a> </li>
...
<?php endif; ?><?php /**PATH /home/wec24/public_html/application/resources/views/pages/task/content/tabmenu.blade.php ENDPATH**/ ?>