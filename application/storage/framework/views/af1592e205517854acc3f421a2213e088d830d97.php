...
<div class="kanban-card kanban-board-element show-modal-button reset-card-modal-form js-ajax-ux-request"
    ...
    <div class="kanban-card-content-comntainer">
        <div class="x-title wordwrap" id="kanban_task_title_<?php echo e($task->task_id); ?>"><?php echo e(($task->task_job_number != null ? $task->task_job_number." - " : "").$task->task_title); ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/wec24/public_html/application/resources/views/pages/tasks/components/kanban/card.blade.php ENDPATH**/ ?>