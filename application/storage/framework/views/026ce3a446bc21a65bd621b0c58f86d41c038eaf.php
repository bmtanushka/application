...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            <label
                class="col-sm-12 col-lg-3 text-left control-label col-form-label required">Job Number</label>
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control form-control-sm" id="task_job_number" name="task_job_number"
                    placeholder="">
            </div>
        </div>
...
</div><?php /**PATH /home/wec24/public_html/application/resources/views/pages/tasks/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>