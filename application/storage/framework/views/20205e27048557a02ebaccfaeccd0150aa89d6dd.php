    ...
    <div class="x-section">
        ...
        <div class="x-element" id="card-task-status"><i class="mdi mdi-flag"></i>
            ...
            <?php if($task->permission_edit_task && FALSE): ?>
        ...
        <div class="x-element" id="card-task-priority"><i class="mdi mdi-flag"></i>
            ...
            <span class="x-highlight x-editable js-card-settings-button-static" data-container=".card-modal"
                ...
                data-title="<?php echo e(cleanLang(__('lang.priority'))); ?>"><?php echo e(runtimeLang($task->taskpriority_title)!=""?runtimeLang($task->taskpriority_title):"N/A"); ?></strong></span>
            <?php else: ?>
            <span class="x-highlightx"><?php echo e(runtimeLang($task->taskpriority_title)); ?></span>
            <?php endif; ?>
        </div>
    ...
    </div><?php /**PATH /home/wec24/public_html/application/resources/views/pages/task/rightpanel.blade.php ENDPATH**/ ?>