...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>"
    ...
    <div id="list-page-actions">
        ...
        <?php endif; ?>
        <?php if(auth()->user()->is_client && in_array(auth()->user()['id'], SP_CLIENT_USERS)): ?>
        <button type="button" class="btn btn-danger btn-add-circle edit-add-modal-button js-ajax-ux-request reset-target-modal-form " data-toggle="modal" data-target="#commonModal" data-url="/tasks/create?taskresource_id=<?php echo SP_CLIENT_PROJECT[auth()->user()['id']]; ?>&amp;taskresource_type=project" data-loading-target="commonModalBody" data-modal-title="Add A New Job" data-action-url="/tasks?taskresource_id=<?php echo SP_CLIENT_PROJECT[auth()->user()['id']]; ?>&amp;taskresource_type=project&amp;xcount=45" data-action-method="POST" data-action-ajax-class="" data-modal-size="" data-action-ajax-loading-target="commonModalBody" data-save-button-class="" data-project-progress="0">
            <i class="ti-plus"></i>
        </button>
        <?php endif; ?>
    </div>
</div><?php /**PATH /home/wec24/public_html/application/resources/views/pages/tasks/components/misc/list-page-actions.blade.php ENDPATH**/ ?>