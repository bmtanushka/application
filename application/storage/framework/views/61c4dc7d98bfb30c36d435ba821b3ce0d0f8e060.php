    ...
    <div class="card">
        <div class="card-body p-l-15 p-r-15">
            <div class="d-flex p-10 no-block">
                <a href="/invoices?db_filter_bill_due_date_mtd=yes&db_project_status=in-progress">
                    <span class="align-slef-center">
                        <h2 class="m-b-0"><?php echo e(runtimeMoneyFormat($payload['invoices']['overdue'])); ?></h2>
                        <h6 class="text-muted m-b-0">Working Jobs Total - MTD</h6>
                    </span>
                </a>
...
</div><?php /**PATH /home/wec24/public_html/application/resources/views/pages/home/client/widgets/first-row/invoices-overdue.blade.php ENDPATH**/ ?>