<div class="chat-right-aside" id="messages_right_text_wrapper">
    ...
    <div id="replying_text_wrapper">
        <!--text box-->
        <span type="button" class="btn-close" onclick="replyClose()" aria-label="Close">&#10006;</span>
        <div id="replying_text_viewer" class=""></div>
    </div>
    <div class="card-post" id="messaging_submit_container" style="border-top: solid 2px #b4d1e3;">
        ...
        <button type="button" id="messaging_submit_button"
            class="btn btn-danger btn-icon-circlex messaging_submit_button ajax-request"
            ...
            <i class="sl-icon-paper-planex">Send Message</i>
        </button>
        ...
        <div id="message_meta_contaier">
            ...
            <input type="hidden" name="message_parent_id" id="message_parent_id" value="">
