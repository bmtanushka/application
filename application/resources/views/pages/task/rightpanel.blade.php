    ...
    <div class="x-section">
        ...
        <div class="x-element" id="card-task-status"><i class="mdi mdi-flag"></i>
            ...
            @if($task->permission_edit_task && FALSE)
        ...
        <div class="x-element" id="card-task-priority"><i class="mdi mdi-flag"></i>
            ...
            <span class="x-highlight x-editable js-card-settings-button-static" data-container=".card-modal"
                ...
                data-title="{{ cleanLang(__('lang.priority')) }}">{{ runtimeLang($task->taskpriority_title)!=""?runtimeLang($task->taskpriority_title):"N/A" }}</strong></span>
            @else
            <span class="x-highlightx">{{ runtimeLang($task->taskpriority_title) }}</span>
            @endif
        </div>
